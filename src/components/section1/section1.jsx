...
export default function Section1(){
    return(
        ...
        <div id="section1" className="section1 container-fluid bg-black ">
            <div className="sec1_content pt-5 pb-5">
                <h2 className="pt-3 display-7 text-center">Who We Are</h2>
                <p className="pt-3 mx-5 fs-6 text lead text-light text-center">Welcome to Exe.lk (Pvt) Ltd, where we turn ideas into reality! With innovation at our core, our skilled team crafts cutting-edge solutions that empower businesses and individuals alike. From web applications to mobile solutions, our tailored approach ensures we not only meet but exceed expectations. Whether you are an aspiring entrepreneur or a visionary enterprise, we are here to transform your concepts into tangible success. Embrace this journey of innovation with us, and together, let&apos; create something extraordinary. Welcome to Exe.lk (Pvt) Ltd, where your ideas take flight – making the impossible possible!</p>
                <div className="sec1_content_footer">
                    <h5 className="pt-5 text-center"><a className={'text-decoration-none'} href="/about-us">Read More</a></h5>
                </div>
            </div>
            <div className={'technologies pt-5 pb-5'}>
                <h2 className={'display-7 text-center pb-5'}>We are experts in</h2>
