            ...
            <div id="section2" class="section2 container-fluid">
                <div class="container sec2_content">
                    ...
                    <div className="row">
                        ...
                        <ServiceCard header="Web, Mobile & Pc Application" body="Seamless Digital Experiences: Elevate Your Reach with Expert Web, Mobile, and PC Applications!" hreflink="pages/services/softwareapplication"/>
